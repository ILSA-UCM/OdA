...
$service_url = $ServerService.'exportOda2?user='.TZN_DB_EXTERNAL_USER.'&password='.TZN_DB_EXTERNAL_PASS.'&server='.TZN_DB_EXTERNAL_HOST.'&database='.TZN_DB_BASE.'&port=3306&url=http://'.TZN_ODA_HOST.'/'.APP_NAME.'&convert=true&userclavy='.Clavyuser.'&passwordclavy='.Clavyuserkey.'&KeyClavy='.Clavykey;
...
if ($curl_response === false) {
    ...
    curl_close($curl);
	echo "<br>";
	echo 'El sistema Clavy en http://'.ClavyServer.':'.ClavyPort.' ha dado un error en la actualizacion de oda, por favor intentelo de nuevo';
	echo "<br>";
	echo $curl_response;
	echo "<br>";
