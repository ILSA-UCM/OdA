...
<? } ?>							
							...
							<? if ($visit->options->usuario->puedeRegenerarNav()){ ?>
								<td class="menu_derecha" style="width:165px;border-left:0px;text-align:center;" onmouseover="this.className='menu_derechaover';"	onmouseout="this.className='menu_derecha'">
									<a href="<?=$_parenDir?>bo/do.php?op=regenera_navegacion">Regenerar Navegación</a>
								</td>
							<?}?>
						</tr>
					</table>
