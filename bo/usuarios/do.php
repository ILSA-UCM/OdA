...
if ($op=="") {
	echo utf8_encode("Operaci�n no v�lida");
	exit();
}
else if ($op=="login") {
	...
	// A�adida Seguridad en Login Porr Joaquin Gayoso-Cabada 02102021
	if ( password_verify($dict["password"], $user->password) && ($user->login==$dict["login"] ) ) {
	// Fin A�adida Seguridad en Login Porr Joaquin Gayoso-Cabada 02102021	
