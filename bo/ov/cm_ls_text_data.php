...
<TD width="13" class="<?= $lsregistros ?>"><a href="cm_form_text_data.php?id=<?= $filas[$i]->id ?>"><IMG SRC="img/ico_editar.gif" WIDTH="13" HEIGHT="16" BORDER="0" ALT=""></a></TD>
			...
			<TD class="<?= $lsregistros ?>">
				<A HREF="do.php?op=mover_text_data&id=<?= $filas[$i]->id ?>&valor=1"><IMG SRC="img/flecha_up.gif" WIDTH="16" HEIGHT="16" BORDER="0" ALT=""></A>
				<A HREF="do.php?op=mover_text_data&id=<?= $filas[$i]->id ?>&valor=-1"><IMG SRC="img/flecha_down.gif" WIDTH="16" HEIGHT="16" BORDER="0" ALT=""></A>
			</td>
			<TD class="<?= $lsregistros ?>">		
				<A HREF="#" onclick="
