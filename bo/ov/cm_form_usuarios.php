...
if (!$visit->options->usuario->esRolSuperadmin()) $visit->util->redirect("login.php");
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="1" style="border:1px solid #CCCCCC;">
		...
		<tr>
				...
				<UL style="margin-top:6px;margin-bottom:4px;">
					<LI class="liayudaformulario"><B>Superadministrador</B> (Usuario con permisos para gestionar <B>todos</B> los contenidos del gestor, los objetos y los usuarios)
					<LI class="liayudaformulario"><B>Administrador</B> (Usuario con permisos para  <B>crear</B> y <B>modificar</B> sus objetos virtuales)
					<LI class="liayudaformulario"><B>Usuario</B> (Usuario con permisos para consultar <B>todos</B> los contenidos del gestor)				
				</UL>
