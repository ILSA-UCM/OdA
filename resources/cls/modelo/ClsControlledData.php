<?
class ClsControlledData extends ClsModelo {
	...
	var $_orderby="idov, idseccion, value, id";
	...
	function construyeCadenaFiltro() {
		...
		$res = $this->getSQLBusqueda( "idrecurso", $this->idrecurso, $res);
