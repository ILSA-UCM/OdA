...
function show_calendar_submit(str_target, str_datetime, strForm) {
	...
	var str_buffer = new String (
		...
		"<img src=\""+ prefijoImg +"plus2.gif\" width=\"16\" height=\"16\" border=\"0\""+
		...
		"<img src=\""+ prefijoImg +"plus.gif\" width=\"16\" height=\"16\" border=\"0\""+
		" alt=\"next month\"></a></td>\n</tr>\n"
	);
...
function str2dt (str_datetime) {
	...
	if (!re_date.exec(str_datetime)) {
		alert("Formato de fecha no válido: "+ str_datetime +"; mostramos la fecha actual.");
		return null;
	}
