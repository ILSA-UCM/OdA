...
<TABLE  border="0" width="100%" height="300" cellpadding="0" cellspacing="0">
	<TR>
		...
		<!--<? } else if ($op=="modificar_usuarios" && $existeCorreo) {?>
			...
			<BR><BR><BR><BR>
			<A HREF="cm_form_usuarios.php"><IMG SRC="/bo/img/boton_ver_recurso.gif" WIDTH="87" HEIGHT="24" BORDER="0" ALT=""></A>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<A HREF="cm_ls_usuarios.php"><IMG SRC="/bo/img/boton_ir_listado.gif" WIDTH="87" HEIGHT="24" BORDER="0" ALT=""></A> 
		<? } else if ($visit->util->getFirstPart($op,"_")=="clonar") {?>
			Los datos se han clonado satisfactoriamente
			
			<BR><BR><BR><BR>
			<A HREF="<?= $volverRecurso ?>"><IMG SRC="/bo/img/boton_ver_recurso.gif" WIDTH="87" HEIGHT="24" BORDER="0" ALT=""></A>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<A HREF="<?= $volverListado ?>"><IMG SRC="/bo/img/boton_ir_listado.gif" WIDTH="87" HEIGHT="24" BORDER="0" ALT=""></A> 
